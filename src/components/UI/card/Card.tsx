...
const Card: React.FC<Props> = ({ product }) => {
  ...
  return (
    <div className="col-span-6 sm:col-span-3 md:col-span-4 lg:col-span-3 2xl:col-span-2 shadow-xl my-1 md:my-4  rtl:ml-1 md:mx-6  bg-palette-card rounded-xl flex relative">
      <Link
