...
-- AddForeignKey
ALTER TABLE "Slider" ADD CONSTRAINT "Slider_slug_fkey" FOREIGN KEY ("slug") REFERENCES "Category"("href") ON DELETE RESTRICT ON UPDATE CASCADE;
